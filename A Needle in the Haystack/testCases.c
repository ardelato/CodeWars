...
// static void test##(){}
static void test01(){
   char *strArr[] = {"hay", "junk", "hay", "hay","moreJunk", "needle", "randomJunk"};
   char *needleString = find_needle(strArr,sizeof(strArr)/sizeof(strArr[0]));
   TEST_STRING(needleString, "found the needle at position 5");
}
