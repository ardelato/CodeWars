...
static void test01(){
   int *returnVal = race(720,850,70);

   TEST_SIGNED(returnVal[0],0);
   TEST_SIGNED(returnVal[1],32);
   TEST_SIGNED(returnVal[2],18);
}

static void test02(){
   int *returnVal = race(80,91,37);

   TEST_SIGNED(returnVal[0],3);
   TEST_SIGNED(returnVal[1],21);
   TEST_SIGNED(returnVal[2],49);
}

static void test03(){
 int *returnVal = race(820,81,550);

   TEST_SIGNED(returnVal[0],-1);
   TEST_SIGNED(returnVal[1],-1);
   TEST_SIGNED(returnVal[2],-1);
}

static void test04(){
   int *returnVal = race(820,850,550);

   TEST_SIGNED(returnVal[0],18);
   TEST_SIGNED(returnVal[1],20);
   TEST_SIGNED(returnVal[2],0);
}
