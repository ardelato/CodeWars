...
// static void test##(){}
static void test01(){
   const int list[] = {1, 3, 5, 9, 11};
   int returnValue = find_missing(list,5ul);
   TEST_SIGNED(returnValue,7);
}

static void test02(){
   const int list[] = {0,0,0,0};
   int returnValue = find_missing(list,4ul);
   TEST_SIGNED(returnValue,0);
}

static void test03(){
   const int list[] = {1, 5, 7, 9, 11, 13};
   int returnValue = find_missing(list,6ul);
   TEST_SIGNED(returnValue,3);
}

static void test04(){
   const int list[] = {197, 41, -115, -427, -583, -739, -895, -1051, -1207, -1363, -1519, -1675, -1831, -1987, -2143, -2299, -2455, -2611, -2767, -2923, -3079, -3235, -3391, -3547, -3703, -3859, -4015, -4171};
   int returnValue = find_missing(list,28ul);
   TEST_SIGNED(returnValue,-271);
}
